                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel-body">
                            ...
                            {
                                ?>
                                <form method="post" action="<?php echo base_url(); ?>index.php/operators/delete/<?php echo $id; ?>">
                                <input type="hidden" name="id" value="" />
                                <button class="btn btn-large btn-primary" type="submit" name="btn-del"><i class="glyphicon glyphicon-trash"></i> &nbsp; YES</button>
                                <a href="<?php echo base_url(); ?>index.php/operators/delete/<?php echo $id; ?>" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
                                </form>  
                                <?php
                            }
                            else
