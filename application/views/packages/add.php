                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_url(); ?>index.php/packages/add/" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="estTime" placeholder="Estimated Wash Time">
                                        </div>
                                        <div class="form-group">
                                            <label>Details</label>
